        ...
        new ApiUtil(context)
                ...
                .subscribe(new Observer<ResultModel>() {
                    ...
                    public void onNext(ResultModel resultModel) {
                        //更新视图
                        MatchContract matchContract = (MatchContract)view;
                        matchContract.excuteResult(true,resultModel);
                        //view.success(resultModel);
                    }
                    @Override
                    public void onError(Throwable e) {
                        ...
                        e.printStackTrace();
                        MatchContract matchContract = (MatchContract)view;
                        matchContract.excuteResult(false,e);
                        //view.failed(e);
                    }
                    @Override
                    public void onComplete() {
        ...
        new ApiUtil(context)
                ...
                .subscribe(new Observer<ResultModel>() {
                    ...
                    public void onNext(ResultModel resultModel) {
                        //更新视图
                        MatchContract matchContract = (MatchContract)view;
                        matchContract.deleteMatchResult(true,resultModel);
                        //view.success(resultModel);
                    }
                    @Override
                    public void onError(Throwable e) {
                        ...
                        e.printStackTrace();
                        MatchContract matchContract = (MatchContract)view;
                        matchContract.deleteMatchResult(false,e);
                        //view.failed(e);
                    }
                    @Override
                    public void onComplete() {
