...
import com.jenking.xiaoyunhui.activity.TeamCreateActivity;
...
public class MineTeamFragment extends Fragment implements TeamContract{
    ...
    @BindView(R.id.create_team_in)
    LinearLayout create_team_in;
    ...
    @OnClick({R.id.create_team_in_text,R.id.create_team_in})
    void create_team(){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view =  inflater.inflate(R.layout.fragment_mine_team,container,false);
    ...
    private void initData(){
        ...
        baseRecyclerAdapter = new BaseRecyclerAdapter<TeamModel>(getContext(),teamModels,R.layout.fragment_part3_layout_item) {
            @Override
    ...
    public void onResume() {
        ...
        if (!AccountTool.isLogin(getContext())){
            ...
            create_team_in.setVisibility(View.GONE);
        }else{
            tips_text.setVisibility(View.GONE);
            if (AccountTool.getUserType(getContext()).equals(Const.User_type_normal)){
                create_team_in.setVisibility(View.VISIBLE);
            }else{
                create_team_in.setVisibility(View.GONE);
            }
        }
    ...
    private void getData(){
        if (AccountTool.isLogin(getContext())){
            ...
            params.put("team_create_user", AccountTool.getLoginUser(getContext()).getUser_id());
