...
import com.jenking.xiaoyunhui.adapter.score2.PublishRefereeAdapter;
...
public class PublishScoreRefereeFragment extends Fragment {
    private Unbinder unbinder;
    private Context context;
    private PublishRefereeAdapter publishAdapter;
    ...
    private void initData(){
        ...
        datas.add("");
        datas.add("");
        publishAdapter = new PublishRefereeAdapter(R.layout.fragment_publish_score2_item,datas);
